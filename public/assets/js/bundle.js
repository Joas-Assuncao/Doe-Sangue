...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  width: 100%;\n  padding: 1.5rem 1.5rem 1.5rem 0.7rem;\n  background: var(--blue);\n  position: fixed;\n}\nheader h2 {\n  display: flex;\n  align-items: center;\n  letter-spacing: 0.4rem;\n  font-size: 1.5rem;\n  font-family: \"Rum Raisin\", sans-serif;\n}\nheader h2 img {\n  height: 3.125rem;\n  width: 3.125rem;\n  margin-right: 1rem;\n}\nheader nav {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  width: 40%;\n}\nheader nav label {\n  font-size: 0;\n  display: none;\n}\nheader nav label img {\n  max-width: 2rem;\n}\nheader nav ul {\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n}\nheader nav ul li {\n  list-style: none;\n}\nheader nav ul li a {\n  font-size: 1.2rem;\n  text-decoration: underline;\n  text-transform: capitalize;\n}\n\n.menu-on {\n  flex-direction: column;\n  align-items: center;\n  justify-content: space-evenly;\n  height: 100vh;\n  width: 100vw;\n  top: 0;\n  left: 0;\n  background: var(--blue);\n  position: absolute;\n  overflow-y: none;\n  transition: 0.5s;\n}\n.menu-on li a {\n  display: block;\n  font-size: 1.5rem;\n  transition: 0.5s;\n  padding: 0.3rem 0.7rem;\n}\n.menu-on li a:hover {\n  background: #020225;\n  border-radius: 1rem;\n  opacity: 50%;\n  box-shadow: 0 0 10px 10px #020225;\n}\n\n.image-menu {\n  position: absolute;\n}\n\nmain {\n  background: var(--black);\n  padding-top: 6.125rem;\n}\nmain .paragraphs {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 5rem;\n}\nmain .paragraphs p {\n  max-width: 31.25rem;\n  font-size: 1.25rem;\n}\nmain .paragraphs p a {\n  color: var(--red);\n}\nmain .image {\n  width: 100%;\n  text-align: center;\n}\nmain .image img {\n  max-width: 34.375rem;\n}\nmain #donates {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  margin-top: 3rem;\n  margin-bottom: 3rem;\n}\nmain #donates div {\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  justify-content: center;\n  width: 6rem;\n  padding: 0 1rem;\n}\nmain .align-button {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  margin-bottom: 3rem;\n}\nmain .align-button #button {\n  width: 22rem;\n  padding: 1rem 0;\n  border-radius: 1rem;\n  border-bottom: 2px solid var(--blue2);\n  border-right: 2px solid var(--blue2);\n  border-top: 2px solid var(--blue2);\n  border-left: none;\n  background: var(--blue);\n  font-size: 1.2rem;\n  cursor: pointer;\n  transition: 0.3s;\n}\nmain .align-button #button:hover {\n  box-shadow: 0 0 10px var(--blue);\n  opacity: 80%;\n}\nmain .table {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\nmain table {\n  border: 1px solid var(--white);\n  border-radius: 1rem;\n  margin: 0 0 2rem 0;\n}\nmain table tr:nth-of-type(2) td {\n  font-size: 1.25rem;\n  font-weight: bold;\n}\nmain table tr th {\n  font-size: 1.5rem;\n  font-weight: bold;\n  padding: 1rem;\n  border-bottom: 1px solid var(--white);\n}\nmain table tr td {\n  padding: 1rem 4rem;\n  text-align: center;\n}\n\nfooter {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: 30vh;\n  padding: 1rem 3rem;\n}\nfooter div {\n  display: flex;\n  text-align: center;\n  flex-direction: column;\n  justify-content: space-evenly;\n  height: 100%;\n}\nfooter div h4 {\n  font-size: 1.25rem;\n  color: var(--black);\n}\nfooter div a {\n  font-size: 1rem;\n  color: var(--black);\n}\n\n@media (max-width: 1230px) {\n  html {\n    font-size: 93.75%;\n  }\n\n  header nav {\n    width: 45%;\n  }\n}\n@media (max-width: 1130px) {\n  article.paragraphs {\n    flex-direction: column;\n    padding: 0 2rem 3rem 2rem;\n  }\n  article.paragraphs p {\n    padding: 3rem 0 1rem 0;\n    text-align: center;\n  }\n\n  div.image img {\n    max-width: 33rem;\n  }\n}\n@media (max-width: 850px) {\n  header {\n    position: static;\n  }\n  header nav {\n    justify-content: flex-end;\n  }\n  header nav label {\n    display: block;\n  }\n  header nav ul li a {\n    display: none;\n  }\n\n  main {\n    padding: 0;\n  }\n}\n@media (max-width: 640px) {\n  footer {\n    height: 25vh;\n  }\n  footer div h4 {\n    font-size: 1.25rem;\n    color: var(--black);\n  }\n  footer div a {\n    font-size: 1rem;\n    color: var(--black);\n  }\n}\n@media (max-width: 540px) {\n  div.image img {\n    max-width: 26rem;\n  }\n}\n@media (max-width: 520px) {\n  footer div h4 {\n    font-size: 1.15rem;\n    color: var(--black);\n  }\n  footer div a {\n    font-size: 0.9rem;\n    color: var(--black);\n  }\n}\n@media (max-width: 480px) {\n  html {\n    font-size: 87.5%;\n  }\n}\n@media (max-width: 450px) {\n  html {\n    font-size: 81.25%;\n  }\n}\n@media (max-width: 420px) {\n  footer {\n    height: 20vh;\n    padding: 0.75rem 1rem;\n  }\n  footer div {\n    text-align: left;\n  }\n}\n@media (max-width: 375px) {\n  html {\n    font-size: 75%;\n  }\n}\n@media (max-width: 330px) {\n  main div.image img {\n    max-width: 21rem;\n  }\n  main div.input-button input {\n    padding: 1rem 0 1rem 0.75rem;\n    border-radius: 1.5rem 0 0 1.5rem;\n  }\n  main div.input-button button {\n    padding: 1rem;\n    border-radius: 0 1.5rem 1.5rem 0;\n  }\n\n  footer {\n    flex-direction: column;\n    justify-content: space-evenly;\n    align-items: center;\n  }\n  footer div {\n    flex-direction: row;\n    align-items: center;\n    justify-content: space-between;\n    width: 100%;\n  }\n}\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n  text-decoration: none;\n  outline: none;\n  font-family: \"Poppins\", sans-serif;\n  color: var(--white);\n}\n\n:root {\n  --white: #f1f1f1;\n  --blue: #080746;\n  --blue2: #06053a;\n  --black: #212121;\n  --red: #FF6366;\n}\n\n/*# sourceMappingURL=style.css.map */\n", "",{"version":3,"sources":["webpack://./src/assets/css/modules/_header.scss","webpack://./src/assets/css/style.css","webpack://./src/assets/css/modules/_main.scss","webpack://./src/assets/css/modules/_footer.scss","webpack://./src/assets/css/modules/_mediaQueries.scss","webpack://./src/assets/css/style.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,mBAAA;EACA,8BAAA;EAEA,WAAA;EAEA,oCAAA;EAEA,uBAAA;EAEA,eAAA;ACHJ;ADKI;EACI,aAAA;EACA,mBAAA;EAEA,sBAAA;EAEA,iBAAA;EACA,qCAAA;ACLR;ADOQ;EACI,gBAAA;EACA,eAAA;EAEA,kBAAA;ACNZ;ADUI;EACI,aAAA;EACA,mBAAA;EACA,yBAAA;EACA,UAAA;ACRR;ADUQ;EACI,YAAA;EACA,aAAA;ACRZ;ADUY;EACI,eAAA;ACRhB;ADYQ;EACI,aAAA;EACA,8BAAA;EAEA,WAAA;ACXZ;ADaY;EACI,gBAAA;ACXhB;ADYgB;EACI,iBAAA;EACA,0BAAA;EACA,0BAAA;ACVpB;;ADiBA;EACI,sBAAA;EACA,mBAAA;EACA,6BAAA;EAEA,aAAA;EACA,YAAA;EAEA,MAAA;EACA,OAAA;EACA,uBAAA;EAEA,kBAAA;EACA,gBAAA;EACA,gBAAA;ACjBJ;ADoBQ;EACI,cAAA;EACA,iBAAA;EACA,gBAAA;EACA,sBAAA;AClBZ;ADoBY;EACI,mBAAA;EACA,mBAAA;EACA,YAAA;EACA,iCAAA;AClBhB;;ADwBA;EACI,kBAAA;ACrBJ;;AC5EA;EACI,wBAAA;EACA,qBAAA;AD+EJ;AC7EI;EACI,aAAA;EACA,mBAAA;EACA,8BAAA;EAEA,aAAA;AD8ER;AC5EQ;EACI,mBAAA;EAEA,kBAAA;AD6EZ;AC3EY;EACI,iBAAA;AD6EhB;ACxEI;EACI,WAAA;EACA,kBAAA;AD0ER;ACxEQ;EACI,oBAAA;AD0EZ;ACtEI;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;EAEA,WAAA;EAEA,gBAAA;EACA,mBAAA;ADsER;ACpEQ;EACI,aAAA;EACA,mBAAA;EACA,sBAAA;EACA,uBAAA;EAEA,WAAA;EAEA,eAAA;ADoEZ;AChEI;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;EAEA,WAAA;EAEA,mBAAA;ADgER;AC9DQ;EACI,YAAA;EAEA,eAAA;EAEA,mBAAA;EAEA,qCAAA;EACA,oCAAA;EACA,kCAAA;EACA,iBAAA;EAEA,uBAAA;EAEA,iBAAA;EAEA,eAAA;EACA,gBAAA;AD0DZ;ACxDY;EACI,gCAAA;EACA,YAAA;AD0DhB;ACrDI;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,sBAAA;ADuDR;ACpDI;EACI,8BAAA;EACA,mBAAA;EACA,kBAAA;ADsDR;ACnDY;EACI,kBAAA;EACA,iBAAA;ADqDhB;AClDY;EACI,iBAAA;EACA,iBAAA;EAEA,aAAA;EAEA,qCAAA;ADkDhB;AC/CY;EACI,kBAAA;EACA,kBAAA;ADiDhB;;AEtKA;EACI,aAAA;EACA,mBAAA;EACA,8BAAA;EAEA,YAAA;EAEA,kBAAA;AFuKJ;AErKI;EACI,aAAA;EACA,kBAAA;EACA,sBAAA;EACA,6BAAA;EACA,YAAA;AFuKR;AErKQ;EACI,kBAAA;EACA,mBAAA;AFuKZ;AEpKQ;EACI,eAAA;EACA,mBAAA;AFsKZ;;AG7LA;EACI;IACI,iBAAA;EHgMN;;EG5LM;IACI,UAAA;EH+LV;AACF;AG3LA;EACI;IACI,sBAAA;IACA,yBAAA;EH6LN;EG3LM;IACI,sBAAA;IACA,kBAAA;EH6LV;;EGxLM;IACI,gBAAA;EH2LV;AACF;AGvLA;EACI;IACI,gBAAA;EHyLN;EGvLM;IACI,yBAAA;EHyLV;EGvLU;IACI,cAAA;EHyLd;EGrLc;IACI,aAAA;EHuLlB;;EGjLE;IACI,UAAA;EHoLN;AACF;AGjLA;EACI;IACI,YAAA;EHmLN;EGhLU;IACI,kBAAA;IACA,mBAAA;EHkLd;EG/KU;IACI,eAAA;IACA,mBAAA;EHiLd;AACF;AG5KA;EAEQ;IACI,gBAAA;EH6KV;AACF;AGzKA;EAGY;IACI,kBAAA;IACA,mBAAA;EHyKd;EGtKU;IACI,iBAAA;IACA,mBAAA;EHwKd;AACF;AGnKA;EACI;IACI,gBAAA;EHqKN;AACF;AGlKA;EACI;IACI,iBAAA;EHoKN;AACF;AGjKA;EACI;IACI,YAAA;IACA,qBAAA;EHmKN;EGjKM;IACI,gBAAA;EHmKV;AACF;AG/JA;EACI;IACI,cAAA;EHiKN;AACF;AG9JA;EAGY;IACI,gBAAA;EH8Jd;EGzJU;IACI,4BAAA;IACA,gCAAA;EH2Jd;EGxJU;IACI,aAAA;IACA,gCAAA;EH0Jd;;EGrJE;IACI,sBAAA;IACA,6BAAA;IACA,mBAAA;EHwJN;EGtJM;IACI,mBAAA;IACA,mBAAA;IACA,8BAAA;IAEA,WAAA;EHuJV;AACF;AI/SA;EACI,sBAAA;EACA,SAAA;EACA,UAAA;EAEA,qBAAA;EACA,aAAA;EACA,kCAAA;EAEA,mBAAA;AJ+SJ;;AI5SA;EACI,gBAAA;EACA,eAAA;EACA,gBAAA;EACA,gBAAA;EACA,cAAA;AJ+SJ;;AAEA,oCAAoC","sourceRoot":""}]);
// Exports
...
var blood = [document.querySelector('input[value="A+"]'), document.querySelector('input[value="A-"]'), document.querySelector('input[value="B+"]'), document.querySelector('input[value="B-"]'), document.querySelector('input[value="O+"]'), document.querySelector('input[value="O-"]'), document.querySelector('input[value="AB+"]'), document.querySelector('input[value="AB-"]')];
button.addEventListener('click', function () {
  var type = blood.reduce(checkInputs, 0);
  createTable(type);
  return;
});
